...
def single_player(player1_cards, player1_value, dealer_cards, dealer_value)
...
def multi_player(player1_cards, player1_value, player2_cards, player2_value, dealer_cards, dealer_value)
...
def start_game
  ...
  puts greeting
  single_player_multi_player = gets.chomp
  if single_player_multi_player == '1'
    puts single_player(player1_cards, player1_value, dealer_cards, dealer_value)
  elsif single_player_multi_player == '2'
    puts multi_player(player1_cards, player1_value, player2_cards, player2_value, dealer_cards, dealer_value)
  elsif single_player_multi_player == !['1','2']
    puts "Choose 1 or 2"
  end
  
  while single_player_multi_player == '1' && player1_value < 21
  ...
  while single_player_multi_player == '1' && dealer_value < 17 || dealer_value < player1_value
  ...
  while single_player_multi_player == '2' && player1_value < 21
  ...
  while single_player_multi_player == '2' && player2_value < 21
  ...
  while single_player_multi_player == '2' && dealer_value < 17 && dealer_value < player1_value && dealer_value < player2_value
    dealer_cards << deck.pop
    dealer_value = calculate_total(dealer_cards)
    puts "Dealer hit and has #{dealer_cards} for a total of: #{dealer_value}"
  ...
  while single_player_multi_player == '1'
  ...
  while single_player_multi_player == '2'
